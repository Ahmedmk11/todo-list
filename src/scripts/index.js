...
let task1 = new Task('test1', 'test test1', '4/20', '69:69', ['tag1', 'tag2', 'tag3'], 3);
let task2 = new Task('test2', 'test test2', '4/20', '69:69', ['tag1', 'tag2', 'tag3'], 3);
let task3 = new Task('test3', 'test test3', '4/20', '69:69', ['tag1', 'tag2', 'tag3'], 3);
